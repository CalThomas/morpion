...
class Gui():
	...
	def main_menu(self):
		...
		self.one_Player_button = tk.Button(self.root,text = "1 Player",command=self.grid_size)
		self.one_Player_button.grid(row = 0, column = 0)

		self.two_Player_button = tk.Button(self.root,text = "2 Player",command=self.grid_size)
